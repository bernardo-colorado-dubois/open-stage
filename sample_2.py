...
csv_origin.add_output(iris_pipe_b).set_destination(iris_switcher)
iris_switcher.add_output(setosa_pipe).set_destination(iris_funnel)
iris_switcher.add_output(versicolor_pipe).set_destination(iris_funnel)
iris_switcher.add_output(virginica_pipe).set_destination(iris_funnel)
iris_funnel.add_output(iris_pipe_b).set_destination(iris_copy)
iris_copy.add_output(iris_pipe_to_csv).set_destination(iris_csv_destination)
iris_copy.add_output(iris_pipe_to_agg).set_destination(iris_counter)
iris_counter.add_output(iris_pipe_to_csv_count).set_destination(iris_count_to_csv)
